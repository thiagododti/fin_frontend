...
export function ProfileDialog({ open, onOpenChange }: ProfileDialogProps) {
    ...
    const mutation = useMutation({
        mutationFn: (values: ProfileFormValues) => {
            ...
            return usersApi.patch(user.id, payload as unknown as Parameters<typeof usersApi.patch>[1]);
        },
        onSuccess: ({ data }) => {
            updateUser(data);
                    ...
                    <div className="flex items-start gap-5">
                        ...
                        <div className="flex-1 space-y-3">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input type="email" {...register('email')} placeholder="email@exemplo.com" disabled className="bg-secondary border-border" />
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input type="date" {...register('birth_date')} className="bg-secondary border-border" />
                            </div>
                        </div>
                    </div>
