...
export const queryKeys = {
    automations: {
        ...
        detail: (id: number) => [...queryKeys.automations.all(), id] as const,
        status: () => [...queryKeys.automations.all(), "status"] as const,
    },
    ...
    departments: {
        ...
        detail: (id: number) => [...queryKeys.departments.all(), id] as const,
    ...
    dashboard: {
        ...
        kpisByAutomation: (filters?: unknown) =>
            ["kpisByAutomation", filters] as const,
    },
    ...
    executions: {
        ...
        detail: (id: number) => [...queryKeys.executions.all(), id] as const,
    ...
    logs: {
        ...
        detail: (id: number) => [...queryKeys.logs.all(), id] as const,
    },
    ...
    steps: {
        ...
        detail: (id: number) => [...queryKeys.steps.all(), id] as const,
    },
    ...
    positions: {
        ...
        detail: (id: number) => [...queryKeys.positions.all(), id] as const,
